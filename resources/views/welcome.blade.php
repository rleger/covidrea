        ...
        <div x-data="{ open: false }" class="relative bg-white overflow-hidden">
            <div class="max-w-screen-xl mx-auto ">
                <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    <div class="pt-10 px-2 sm:px-4 lg:px-6">
                        {{-- Logo --}}
                        <svg class="h-16 w-16 sm:h-24 sm:w-24 lg:h-32 lg:w-32 mx-0 sm:mx-auto lg:mx-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171 233"><g fill="none" fill-rule="evenodd"><g transform="translate(-1)" fill-rule="nonzero"><path d="M171.36 86.1c0-47.17-38.23-85.4-85.39-85.42C38.81.69.58 38.93.58 86.1c0 17.8 5.45 34.33 14.77 48.01h-.03l70.65 99.35h.02l70.65-99.35h-.03c9.3-13.68 14.75-30.21 14.75-48.01z" fill="#5850EC"/><circle fill="#FFF" cx="100.88" cy="68.16" r="22.36"/><path d="M80.08 97.6c-15.92-3.13-31.47 4.24-39.5 17.3 15.68 1.54 33.24 7.74 48.54 21.35l-20.61 29.01c-3.35 5.91-.25 13.43 6.3 15.25 4.32 1.18 9.34-.64 11.72-4.76l23.7-33.32c4.03-20.51-9.67-40.81-30.15-44.83z" fill="#FFF"/></g></g></svg>
                    </div>
                    <div class="mt-6 mx-auto max-w-screen-xl px-4 sm:mt-8 sm:px-6 md:mt-12 lg:mt-20 lg:px-8 xl:mt-18">
