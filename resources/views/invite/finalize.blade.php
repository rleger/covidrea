                    ...
                    <div>
                        ...
                        <div class="mt-6 sm:mt-5">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <div class="max-w-xs rounded-md shadow-sm">
                                        <input name="name" id="name" maxlength=30 value="{{ old('name') }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" autofocus />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <div class="max-w-xs rounded-md shadow-sm">
                                        <input name="email" type="email" id="email" value="{{ old('email') ?? app('request')->input('email') }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <div class="max-w-xs rounded-md shadow-sm">
                                        <input name="phone_mobile" type="tel" value="{{ old('phone_mobile') }}" id="phone_mobile" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                    </div>
